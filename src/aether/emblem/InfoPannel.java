...

{
	...
	public void paint (Graphics page)
	{
		...
		if(Attacker!=null)
			...
			if(DefenderLoc!=0)
				{Defender=Generator.ListBlue[DefenderLoc-1];}
			DefenderLoc = Generator.Map.getNum(FieldDriver.gridImageX, FieldDriver.gridImageY, 3);	
			if(DefenderLoc!=0)
				{Defender=Generator.ListRed[DefenderLoc-1];}
	...
	public void CharInfo(Graphics page)
	{
		...
		if(blueChar!=0)
		{CharString(page,Generator.ListBlue[blueChar-1]);}
		if(redChar!=0)
		{CharString(page,Generator.ListRed[redChar-1]);}
	}
	...
	public void CharString(Graphics page,Character charStats)
	{
		...
		page.drawImage (charStats.getFaceImage(),Space(1+sizeMod),height,demention,demention,this);
		int[] stats = charStats.getStats();int xLoc=1;
		page.setColor(Color.black);
		page.drawString ("Hit Pts:",Space(2+sizeMod),(20+xLoc*15));xLoc++;
		page.drawString ("Attack:",Space(2+sizeMod),(20+xLoc*15));xLoc++;
		page.drawString ("Armor:",Space(2+sizeMod),(20+xLoc*15));xLoc++;
	...
	public void EnvString(Graphics page, String Env)
	{
		...
		page.drawString (Env,Space(6),(25+xLoc*15));xLoc++;
		page.drawString ("Armor: "+def,Space(6),(25+xLoc*15));xLoc++;
